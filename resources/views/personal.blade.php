...
<div class="main-content">
    <div class="list-news-feed">
        ...
        $postOption = 0;
        $postReaction = 0;
        if ($data_user->userPosts->find($post->id)) {
            $postOption = $data_user->userPosts->find($post->id)->pivot->option;
            $postReaction = $data_user->userPosts->find($post->id)->pivot->reaction;
        }
        @endphp
